				...
				<div class="col-lg-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<br>
							<button onclick="deletePost(${detail.idx})" class="btn form-control"
								style="cursor: pointer; margin-top: 0; height: 40px; color: white; background-color: #DF013A; border: 0px solid #388E3C; opacity: 0.8">삭제</button>
